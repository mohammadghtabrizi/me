                                	...
                                	@foreach($blogposts as $blogpost)
                                    	<tr>
                                    	    ...
                                    	    <td>
                                            	...
                                            	<a href="{{route('show_post',['id' => $blogpost->id])}}" class="btn btn-default waves-effect waves-float btn-sm waves-red" title="انسداد پست"><i class="zmdi zmdi-block"></i></a>
                                            	<a href="{{route('show_post',['id' => $blogpost->id])}}" class="btn btn-default waves-effect waves-float btn-sm waves-red" title="نمایش پست"><i class="zmdi zmdi-eye"></i></a>
                                            	<a href="{{route('show_post',['id' => $blogpost->id])}}" class="btn btn-default waves-effect waves-float btn-sm waves-red" title="انتقال به زباله دان"><i class="zmdi zmdi-delete"></i></a>
                                        	</td>
                                    	</tr>
                                    @endforeach
                                </tbody>
