                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form method="POST" action="{{route('add_category_post_act')}}">
                        	@csrf
                            <label for="post_category">نام دسته بندی</label>
                            <div class="form-group">                                
                    	        <input type="text" id="post_category" class="form-control" name="postcategory" placeholder="نام دسته بندی را وارد کنید">
                            </div>
