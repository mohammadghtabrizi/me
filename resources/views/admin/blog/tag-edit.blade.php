        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    ...
                    <form method="get" action="{{route('admin_tags_blog_index')}}">
                        @csrf
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="POST" action="{{route('edit_tag_act',['id' => $edittag->id])}}">
                            @csrf
                            <label for="post_tag">نام تگ</label>
                            <div class="form-group">                                
                                <input type="text" id="post_tag" class="form-control" name="posttag" value="{{$edittag->BT_VALUE}}" placeholder="نام تگ را وارد کنید">
                            </div>
