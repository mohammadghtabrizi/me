<section class="container mb-3" style="width:100%;margin: auto;">
   	<div class="col-xl-12 col-lg-12">
   		<div class="fw-section rounded padding-top-4x padding-bottom-4x" style="background-image: url(img/blog/expert-request.jpg);">
   			<span class="overlay rounded" style="opacity: .35;"></span>
       		<div class="text-center">
       			<h3 class="display-4 text-normal text-white text-shadow mb-3">نیاز به کمک داری ؟</h3>
       			<h2 class="display-2 text-bold text-white text-shadow">با صرف کمترین زمان درخواست کارشناس بده !</h2>
       			<h4 class="d-inline-block h2 text-normal text-white text-shadow border-default border-left-0 border-right-0 mb-4">سامانه هوشمند درخواست کارشناس تعمیرات </h4>
        		<br>
        		<a class="btn btn-primary margin-bottom-none" href="#" data-toggle="modal" data-target="#modalExpertRequest">همین حالا درخواست بده</a>
        	</div>
      	</div>
    </div>
</section>
